...
Route::group(['middleware'=>['auth','role:Super Admin|Admin'],'prefix'=>'backend','as'=>'backend.'],function(){
    ...
    Route::resource('users',App\Http\Controllers\Admin\ItemController::class)->middleware('role:Super Admin');
    ...
    Route::get('order/{voucher}',[App\Http\Controllers\Admin\OrderController::class, 'orderDetail'])->name('orders.detail');
